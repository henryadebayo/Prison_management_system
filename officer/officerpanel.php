...
<h3 align='center'> PRISON MNGNT  SYSTEM FOR THE WARDER  </h3>
<P align='justify'><font face='Arial, Helvetica, sans-serif'>
	The prison warder has the abilty to view information,edit and delete.
 this is for the prison warder. The system enable the warder to check several important information on the system. The warder can also add and upload information.
...
<ul>
          ...
          <li><a href="registration.php"> Inmate Registration</a></li>
          <li><a href="addofficer.php"> Add Warder</a></li>
